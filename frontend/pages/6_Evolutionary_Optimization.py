...
with st.sidebar:
    ...
    start_btn = st.button("Start Evolution", width='stretch')
...
if start_btn:
    ...
    try:
        url = f"{API_URL}/evolution/?symbol={symbol}&pop_size={pop_size}&generations={generations}&mutation_rate={mutation_rate}&target_date={target_date or ''}"
        ...
        for line in response.iter_lines():
            if line:
                ...
                pop_table_placeholder.dataframe(pop_df_display, width='stretch')
